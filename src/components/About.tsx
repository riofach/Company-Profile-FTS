          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded with a vision to bridge the gap between innovative technology and practical business solutions, we have been at the forefront of digital transformation for over a decade.
                </p>
                <p>
                  Our team of experienced professionals combines technical expertise with creative thinking to deliver solutions that not only meet current needs but also anticipate future challenges.
                </p>
                <p>
                  We believe in the power of collaboration and work closely with our clients to understand their unique requirements, ensuring every project is tailored to deliver maximum value.
                </p>
              </div>
            </motion.div>
